...
<section class="site-section site-section-light site-section-top themed-background-dark">
    <div class="container">
        ...
        <h2 class="h3 text-center animation-slideUp">Registration Below</h2>
    </div>
</section>
<!-- END Intro -->
        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-lg-4 col-lg-offset-4 site-block">
                ...
                <form method="post"  class="form-horizontal" >
                  ...
                  <input type="hidden" name="uregno" value="<?php echo "ISF2024-". mt_rand(100000,999999);?>" class="form-control input-lg" required/>
                    ...
                    <b>Payment:</b>
                     <div class="form-group">
                            ...
                            <div class="input-group">
                             <span class="input-group-addon"><i class="gi gi-pen"></i></span>
                                <input type="text" name="amount" value="2000" class="form-control input-lg"  readonly />
                            </div>
...
<div align="center" class="mt-12">
            ...
            <button type="submit" class="btn btn-sm btn-primary" name="btnPay">  MAKE PAYMENT TO CONTINUE</button>
            <img src="img/paystack.png" height="100" width="250" alt="Paystack Logo">
                        </div>
                    </div>
</div>
