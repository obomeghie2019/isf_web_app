...
echo "<h2><font color=grey> $row1[1]</font></h2>";
$rs=mysql_query("select * from mst_test where sub_id=$subid");
if(mysql_num_rows($rs)<1)
{
	echo "<h2 class=head1> No Quiz for this Subject </h2>";
	exit;
}
...
{
	echo "<tr><td align=left><a href=quiz.php?testid=$row[0]&subid=$subid><font size=5>$row[2]</font></a>";
}
echo "</table>";
}
?>
